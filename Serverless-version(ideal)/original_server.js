...
app.use(cors({
    origin: 'https://benefits.hashstudiosllc.com', 
    methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],  // Allow all methods
    allowedHeaders: ['Origin', 'X-Requested-With', 'Content-Type', 'Accept', 'Authorization'],  // Allow additional headers
}));
...
// Form submission endpoint (Endpoint is not used, replaced with lambda)
